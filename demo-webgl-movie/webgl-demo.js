...
function drawFromVideo() { 
 ...
 ctx.fillStyle = "rgba("+parseInt(Math.random()*255)+",0,0,.5)";  
 ctx.fillRect (10, 10, 55, 50);  
 ctx.fillStyle = "rgba(0, 0, 200, 0.5)";  
 ctx.fillRect (30, 30, 55, 50);  
 ctx.drawImage(video, 100, 60, 100+128, 60+128, 0, 0, 128, 128);
} 
